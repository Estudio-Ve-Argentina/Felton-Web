...
function ProductsContent() {
  ...
  const [activeCategory, setActiveCategory] = useState(
    ALL_CATEGORIES.includes(initialCategory) ? initialCategory : "Todos"
  );
  ...
  return (
    <>
      ...
      >
        ...
        {/* Bottom fade to black — se funde con el grid */}
        <div
      ...
      <div className="relative bg-black overflow-hidden">
        {/* Particles — flotan sobre el grid */}
        {PARTICLES.map((p, i) => (
          <motion.div
            key={i}
